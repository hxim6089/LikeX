<template>
  <div class="layout-container" :class="{ 'layout-container--wide': wide }">
    <!-- Left Sidebar -->
    <aside class="sidebar">
      <Sidebar />
    </aside>
    ...
    <!-- Center Feed -->
    <main class="main-feed" :class="{ 'main-feed--wide': wide }">
    ...
    <!-- Right Widgets -->
    <aside v-if="!wide" class="right-panel">
      <RightPanel />
    </aside>
  </div>
</template>
...
.main-feed--wide {
  width: min(1100px, calc(100vw - 315px));
}
