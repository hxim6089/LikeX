...
public class ContentService {
    ...
    public Content addComment(Long parentId, Long authorId, String text) {
        ...
        behaviorService.recordInteraction(authorId, parentId, "COMMENT");
    ...
    public Content repost(Long originalId, Long authorId) {
        ...
        Content savedRepost = contentRepository.save(repost);
        behaviorService.recordInteraction(authorId, originalId, "REPOST");
        return savedRepost;
    }
    ...
    public Content quote(Long originalId, Long authorId, String comment) {
        ...
        Content savedQuote = contentRepository.save(quote);
        behaviorService.recordInteraction(authorId, originalId, "QUOTE");
        return savedQuote;
    }
