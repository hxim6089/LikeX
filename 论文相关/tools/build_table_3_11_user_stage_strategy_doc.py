...
OUT = r"D:\TheEnd\qnyproj-main\recommendation-system\论文相关\表3-11_用户阶段与推荐策略.docx"
...
add_caption(doc, "表 3-11 用户阶段与推荐策略")
table = doc.add_table(rows=1, cols=3)
set_table_width(table, [3.2, 4.3, 8.7])
