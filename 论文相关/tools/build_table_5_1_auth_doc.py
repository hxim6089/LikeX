...
OUT = r"D:\TheEnd\qnyproj-main\recommendation-system\论文相关\表5-1_用户注册登录测试结果.docx"
...
rows = [
    ("T01", "用户注册", "输入用户名和密码，提交注册请求", "注册成功并返回用户信息和 Token", "通过"),
...
add_caption(doc, "表 5-1 用户注册登录测试结果")
