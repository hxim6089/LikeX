...
OUT = r"D:\TheEnd\qnyproj-main\recommendation-system\论文相关\表5-4_推荐排序与用户画像测试结果.docx"
...
rows = [
    ...
    ("T20", "负反馈过滤", "对内容选择不感兴趣或屏蔽作者", "对应内容不再进入推荐候选", "通过"),
    ...
    ("T25", "用户画像", "打开个人画像页面", "展示词云、雷达图与偏好统计", "通过"),
]
...
add_caption(doc, "表 5-4 推荐排序与用户画像测试结果")
