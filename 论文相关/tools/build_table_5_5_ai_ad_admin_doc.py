...
OUT = r"D:\TheEnd\qnyproj-main\recommendation-system\论文相关\表5-5_AI模块广告分发后台管理测试结果.docx"
...
rows = [
    ...
    ("T27", "AI 推荐模式", "Ollama 服务可用时切换 AI 推荐", "返回 AI 排序结果或推荐理由", "通过"),
    ("T28", "AI 降级", "关闭 Ollama 后请求 AI 推荐", "系统降级为基础互动排序", "通过"),
    ("T29", "AI 自动打标", "对帖子执行 AI 打标操作", "系统生成内容标签", "通过"),
    ("T30", "后台用户管理", "管理员查看或管理用户列表", "用户信息能够正常显示或操作", "通过"),
    ("T31", "数据导入", "管理员批量导入公开数据集帖文", "内容库新增帖子或由内置内容库补齐", "通过"),
    ("T32", "广告插入", "浏览首页信息流", "广告按配置间隔插入", "通过"),
    ("T33", "广告统计", "点击信息流广告", "点击次数和展示统计更新", "通过"),
    ("T34", "角色权限", "普通用户访问后台入口或接口", "前端隐藏入口或后端返回权限限制结果", "通过"),
]
...
add_caption(doc, "表 5-5 AI 模块、广告分发与后台管理测试结果")
