...
OUT = r"D:\TheEnd\qnyproj-main\recommendation-system\论文相关\表5-3_社交关系与实时通信测试结果.docx"
...
rows = [
    ...
    ("T12", "关注流展示", "切换到 Following 信息流", "仅展示已关注作者发布的帖子", "通过"),
...
add_caption(doc, "表 5-3 社交关系与实时通信测试结果")
